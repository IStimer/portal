...
import {output} from "three/nodes";
...
//lamps
debugObject.portalColorStart = '#00eeff'
debugObject.portalColorEnd = '#Aafbfd'
...
const poleLightMaterial = new THREE.MeshBasicMaterial({color: '#ffd5cb'})
